...
function martfury_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'source'             => esc_url( 'http://demo2.drfuri.com/plugins/martfury-addons.zip?version=2.4.8' ),
			'required'           => true,
			'force_activation'   => false,
			'force_deactivation' => false,
			'version'            => '2.4.8',
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => esc_url( 'http://demo2.drfuri.com/plugins/revslider.zip?version=6.5.25' ),
			'required'           => false,
			'force_activation'   => false,
			'force_deactivation' => false,
		),
