...
<tr class="woocommerce-shipping-totals shipping">
	<td colspan="2" data-title="<?php echo esc_attr( $package_name ); ?>">
        <h4 class="shipping-title">Verzendkosten</h4>
			...
			<?php if ( is_cart() ) : ?>
				<p class="woocommerce-shipping-destination">
					...
					if ( $formatted_destination ) {
						...
						echo wp_kses_post( apply_filters( 'woocommerce_shipping_estimate_html', esc_html__( 'Verzendopties worden bijgewerkt tijdens het afrekenen.', 'martfury' ) ) );
					}
					?>
				</p>
			<?php endif; ?>
