...
<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="checkout-button button alt wc-forward" style="float:right;margin-bottom:20px;">
	<?php esc_html_e( 'Afrekenen', 'woocommerce' ); ?>
</a>
...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
        ...
        <tr>
            ...
            <th class="product-price"><?php esc_html_e( 'Prijs', 'martfury' ); ?></th>
            <th class="product-quantity"><?php esc_html_e( 'Hoeveelheid', 'martfury' ); ?></th>
            <th class="product-subtotal"><?php esc_html_e( 'Totaalbedrag', 'martfury' ); ?></th>
        ...
        <tr>
            <td colspan="6" class="actions">
				...
				<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" style="min-width: 200px; background-color: #01b901; color: #fff; margin-bottom: 15px;" class="checkout-button button alt wc-forward btn-shop">
                    <?php esc_html_e( 'Afrekenen', 'woocommerce' ); ?>
                </a>
				...
				<a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', get_permalink( get_option( 'woocommerce_shop_page_id' ) ) ) ); ?>"
                   class="btn-shop"><i class="icon-arrow-left"></i> <?php esc_html_e( 'Verder winkelen', 'martfury' ); ?>
                </a>
                ...
                <button type="submit" class="button btn-update <?php echo esc_attr( $hidden ) ?>" name="update_cart"
						value="<?php esc_attr_e( 'Update cart', 'martfury' ); ?>"><?php esc_html_e( 'Update winkelwagen', 'martfury' ); ?></button>
	...
	<?php if ( wc_coupons_enabled() ) { ?>
        <div class="row">
            <div class="col-md-4 col-sm-12 col-coupon">
                <div class="coupon">
				<label for="coupon_code"><?php esc_html_e( 'Kortingcode', 'martfury' ); ?></label>
                    <input type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                           placeholder="<?php esc_attr_e( 'Kortingcode invullen', 'martfury' ); ?>"/>
                    <input type="submit" class="button" name="apply_coupon"
                           value="<?php esc_attr_e( 'Kortingcode toepassen', 'martfury' ); ?>"/>
...
<div class="aftercartcontent"><!-- <p> "Andere klanten kopen ook…" </p> --></div>
