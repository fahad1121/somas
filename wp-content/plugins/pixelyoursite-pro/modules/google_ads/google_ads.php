	...
	public function getPixelOptions() {
        ...
        if(is_array($enhanced_conversion) && count($enhanced_conversion) > 0) {
            ...
            if($user != null && $user->ID != 0) {
                ...
                $userData['phone_number'] = $user_meta['billing_phone']!='' ? $user_meta['billing_phone'] : '';
                $userData['address']['first_name'] = $user->first_name;
                $userData['address']['last_name'] = $user->last_name;
                $userData['address']['street'] = !empty($user_meta['billing_address_1']) ? $user_meta['billing_address_1'] : '';
                $userData['address']['city'] = !empty($user_meta['billing_city']) ? $user_meta['billing_city'] : '';
                $userData['address']['region'] = !empty($user_meta['billing_state']) ? $user_meta['billing_state'] : '';
                $userData['address']['postal_code'] = !empty($user_meta['billing_postcode']) ? $user_meta['billing_postcode'] : '';
                $userData['address']['country'] = !empty($user_meta['billing_country']) ? $user_meta['billing_country'] : '';
